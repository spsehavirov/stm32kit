/**
  ******************************************************************************
  * @file     example_02-extLED.c
  * @author   SPSE Havirov
  * @version  1.0
  * @date     11-March-2022 [v1.0]
  * @brief    Blikani vestavene(ych) a externich LED v nekonecne smycce, pokud 
  *           neni stisknuto uzivatelske tlacitko. Pri stisku uzivatelskeho 
  *           tlacitka svitit vsechny LED.
  *
  ******************************************************************************
  * @attention
  *
...
#define READ_BTN() READ_BIT(USER_BUTTON_PORT->IDR, (1UL << USER_BUTTON))
#define ON (0)
#define OFF (1)
