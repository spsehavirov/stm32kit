 ...
 *         - Odebrani zakomentovane funkce pro kontrolu zaneprazdnenosti LCD,
 *             vcetne odebrani dalsich nepotrebnych radku (vsechny drive zakomentovany)
 *         - Uprava dilcich komentaru, sjednoceni zapisu
 *
 *   v1.0  [10-April-2022]
 *         - Pro pripravek G071 zmena portu a pinu pro ridici signal R/W (puvodni pin uvolnen pro jednu z vestavenych LED)
 *         - Pro pripravek F401 je pro vodic LCD_DB4 vyuzit pin pro SPI_1
 *
 *   v0.9  [12-March-2022]
